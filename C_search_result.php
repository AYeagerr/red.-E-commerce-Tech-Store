...
<div class="sub-menu-wrap" id="subMenu" style="position: absolute;
  ...
  transition: 0.2s;">logout</a>
    ...
    <div class="small-container">
        <div class="row-2">
            <h2>All Chargers</h2>
            <form action="C_search_result.php" method="get" class="search-bar">
                <input type="text" name="query" placeholder="Search chargers..." style="border-radius: 20px; border-color: red;">
            </form>
        ...
        <div class="row">
            <?php if ($result->num_rows > 0): ?>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <div class="col-4">
                        <a href="Chargers details.php?product_id=<?php echo $row['product_id']; ?>"><img src="<?php echo $row['image_url']; ?>" alt="Product Image"></a>
