  ...
  transition: 0.2s;">logout</a>
    ...
    <div class="small-container">
        <div class="row-2">
            ...
            <form action="H_search_result.php" method="get" class="search-bar">
                <input type="text" name="query" placeholder="Search headphones..." style="border-radius: 20px; border-color: red;">
            </form>
        ...
        <div class="row">
            <?php if ($result->num_rows > 0): ?>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <div class="col-4">
                        <a href="Headphones details.php?product_id=<?php echo $row['product_id']; ?>"><img src="<?php echo $row['image_url']; ?>" alt="Product Image"></a>
                        <h4><?php echo $row['NAME']; ?></h4>
                        <p><?php echo $row['stock'] > 0 ? number_format($row['price'], 2) . " LE" : "Out of Stock"; ?></p>
                    </div>
                <?php endwhile; ?>
            <?php else: ?>
