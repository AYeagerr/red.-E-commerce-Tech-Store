...
$randomSql = "SELECT * FROM headphones ORDER BY RAND() LIMIT 4";
...
if (isset($_GET['product_id'])) {
    ...
    $sql = "SELECT * FROM headphones WHERE product_id = ?";
    ...
    if (!$product) {
        ...
        $imagesSql = "SELECT image_url FROM headphones_images WHERE product_id = ?";
